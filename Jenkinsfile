pipeline {
    ...
    environment {
        ...
        S3_BUCKET_NAME        = '28th-cherry-bucket'       // Hardcoded S3 bucket name
    ...
    stages {
        ...
        stage('Fetch Public IP & Create Inventory') {
            steps {
                ...
                script {
                   ...
                   writeFile file: '/home/ubuntu/terraform-auto/Ansible/inventory.ini', text: "[webserver]\n${public_ip} ansible_user=ubuntu"
                 }
            }
      }
      ...
      stage('Run Ansible Playbook') {
          steps {
              ...
              dir('/home/ubuntu/terraform-auto/Ansible') {
                  sh '''
